...
//pencil tool
{
  ...
  if(tool==='pencil'){
    ...
    console.log("hi"+canvas.style.cursor);
  ...
  function startPosition(e){
    if(tool==='pencil'){
      // canvas.style.cursor = "url(https://img.icons8.com/ios-filled/50/000000/pencil--v1.png),auto";
    console.log("hi"+canvas.style.cursor);
    painting = true;
    draw(e);
    }
...
//eraser tool
{
  ...
  function startPosition(e){
    if(tool==='eraser'){
      // canvas.style.cursor = "url(https://img.icons8.com/ios-filled/50/000000/eraser--v1.png),auto";
    console.log("hi"+canvas.style.cursor);
    painting = true;
    draw(e);
    }
